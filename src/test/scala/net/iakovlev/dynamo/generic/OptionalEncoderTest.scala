  ...
  "Experimental generic encoder derivation facility should" >> {
    ...
    "Encode all numeric attributes correctly" >> {
      case class AllNumerals(i: Int,
                             ...
                             b: BigDecimal)
      val res =
        OptionalEncoder[AllNumerals](AllNumerals(1, 2l, 3.0f, 4.0d, BigDecimal(1000l)))
    ...
    "Encode case class with map" >> {
      ...
      val res = OptionalEncoder[MapHost](MapHost(Map("h" -> 1)))
    ...
    "Encode nested case class as map" >> {
      ...
      val res = OptionalEncoder[Parent](Parent("hello", Nested("world")))
    ...
    "Encode scalar list fields" >> {
      ...
      val res = OptionalEncoder[ListHost](ListHost(List("hello", "world")))
      res must_== Map(
    ...
    "Encode document list fields" >> {
      ...
      val res = OptionalEncoder[Parent](Parent(List(Nested("hello"), Nested("world"))))
      res must_== Map(
    ...
    "Encode optional fields" >> {
      ...
      val res = OptionalEncoder[Optional](Optional(Some("s")))
      res must_== Map("o" -> AttributeValue("s"))
      val res1 = OptionalEncoder[Optional](Optional(None))
    ...
    "Encode ADT enum as strings" >> {
      ...
      case class O(b: ADT, c: ADT)
      val res = OptionalEncoder[O](O(B, C))
